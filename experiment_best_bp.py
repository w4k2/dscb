...
experiments = {
                "bp-svm": SVC(probability=True),
                "bp-knn": KNeighborsClassifier(),
                "bp-gnb": GaussianNB(),
                "bp-dtc": DecisionTreeClassifier(),
              }
...
for base_estimator, experiment_name in zip(base_estimators, experiment_names):
    ...
    methods = {
               "DSCB-BP_25": DSCB(base_estimator, balance_ratio=0.25),
               "DSCB-BP_30": DSCB(base_estimator, balance_ratio=0.30),
               "DSCB-BP_35": DSCB(base_estimator, balance_ratio=0.35),
               "DSCB-BP_40": DSCB(base_estimator, balance_ratio=0.40),
               "DSCB-BP_45": DSCB(base_estimator, balance_ratio=0.45),
               "DSCB-BP_50": DSCB(base_estimator, balance_ratio=0.50),
              }
