...
for base_estimator, experiment_name in zip(base_estimators, experiment_names):
    ...
    methods = {
               "DSCB-SMOTE": DSCB(base_estimator, oversampling=over_sampling.SMOTE()),
               "DSCB-ADASYN": DSCB(base_estimator, oversampling=over_sampling.ADASYN()),
               "DSCB-BSMOTE": DSCB(base_estimator, oversampling=over_sampling.BorderlineSMOTE()),
               "DSCB-SVMSMOTE": DSCB(base_estimator, oversampling=over_sampling.SVMSMOTE()),
               "DSCB-RUS": DSCB(base_estimator, oversampling=over_sampling.RandomOverSampler()),
              }
