...
experiments = {
                "xi-svm": SVC(),
                "xi-knn": KNeighborsClassifier(),
                "xi-gnb": GaussianNB(),
                "xi-dtc": DecisionTreeClassifier(),
              }
...
for base_estimator, experiment_name in zip(base_estimators, experiment_names):
    ...
    methods = {
               "DSCB-0.1": DSCB(base_estimator, xi=0.1),
               "DSCB-0.2": DSCB(base_estimator, xi=0.2),
               "DSCB-0.3": DSCB(base_estimator, xi=0.3),
               "DSCB-0.4": DSCB(base_estimator, xi=0.4),
               "DSCB-0.5": DSCB(base_estimator, xi=0.5),
               "DSCB-0.6": DSCB(base_estimator, xi=0.6),
               "DSCB-0.7": DSCB(base_estimator, xi=0.7),
               "DSCB-0.8": DSCB(base_estimator, xi=0.8),
               "DSCB-0.9": DSCB(base_estimator, xi=0.9),
               "DSCB-1.0": DSCB(base_estimator, xi=1.0),
              }
